...
export default class Grupal extends Component {
    ...
    constructor(props) 
    {
        ...
        this.state = 
        {
            ...
            mensajesRealizados: JSON.parse(localStorage.getItem('mensajesRealizadosGrupal')),
            listMensajes: JSON.parse(localStorage.getItem('usulistMensajesGrupal')),

            nombreChat: null,
            idChatSeleccionado: null,
            tipoListMensajesRealizado: 'mensajesRealizadosGrupal',
            tipoListMensajes: 'usulistMensajesGrupal'
        }
    }
    ...
    componentWillMount()
    {
        ...
        {
            writeStorage('mensajesRealizadosGrupal', [])
        }

        if(!this.state.listMensajes)
        {
            writeStorage('usulistMensajesGrupal', [])
        }
